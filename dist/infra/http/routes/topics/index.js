...
topicsRoutes.post('/topics', authMiddleware.middle, createTopicController.handle);
topicsRoutes.delete('/topics/:topicId', authMiddleware.middle, deleteTopicController.handle);
topicsRoutes.get('/topics', authMiddleware.middle, fetchRecentTopicsController.handle);
export { topicsRoutes };
